...
//7.მაღაზიისთვის შევქმნათ პროდუქტების შენახვის სისტემა. უნდა გქონდეთ თვითონ პროდუქტის კლასი, რომელსაც ექნება id,
//სახელი, ფასი, რაოდენობა და არასავალდებულო პროდუქტის აღწერა. ასევე უდნა გვქონდეს Inventory კლასი, რომელშიც შენახული იქნება ყველა პროდუქტი.
//რა თქმა უნდა, ეს სია კლასის გარეთ არ უნდა ჩანდეს. უნდა შეგვეძლოს ამ სიაში ახალი პროდუქტის დამატება, id-ით წაშლა, რაოდენობის შეცვლა,
//id-ის მიხედვით კონკრეტული პროდუქტის წამოღება, მთლიანი ინვენტარის ღირებულების გაგება და პროდუქტების სიის მხოლოდ ნახვა.
